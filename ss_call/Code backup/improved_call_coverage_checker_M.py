...
import dictionaries
from config import SBERT_MODEL_PATH, SCRIPT_EMBEDDINGS_PATH
...
# SBERT Model path - imported at top of file with fallback
try:
    # Paths already imported at top, just verify they exist
    _ = SBERT_MODEL_PATH, SCRIPT_EMBEDDINGS_PATH
except NameError:
    # Fallback paths when config.py import failed
    SBERT_MODEL_PATH = '../multilingual_sbert/paraphrase-multilingual-MiniLM-L12-v2'
    SCRIPT_EMBEDDINGS_PATH = './script_embeddings.pkl'
    print("⚠️  Warning: config.py import failed, using fallback paths")
...
def generate_executive_summary_report(results_df, updated_call_df, script_df, grouped_lines, output_file=None):
    ...
    detailed_coverage_df = detailed_coverage_df.rename(columns={
        ...
        'Best_Matching_Variation': 'Best_Matching_Sentences (Standard Script)'
    })
    ...
    business_friendly_columns = [
        ...
        'Speaker',
        'Best_Matching_Sentences (Standard Script)',
        'Overlapping_Keywords',
        'Group_ID',
